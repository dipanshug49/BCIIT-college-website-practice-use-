            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <p class="mb-1 mt-3 font-weight-semibold">dsdsg</p>
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="post" action="profileinfo.php">
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">BCIIT</label>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
               ...
               <div class="card-body">
                  <form action="profileinfo.php" method="get">
                     <?php
...
$result= "SELECT * from credit where fname='dipanshu'";
if($sql = mysqli_query($con , $result)){
...
while($rows= mysqli_fetch_array($sql)){
    ...
    echo "<h6>" . $rows['yname'] . "<h6>";
     echo "<p>" . $rows['fname'] .  $rows['lname'] . "</p>";
    echo "<h4>" . $rows['email'] . "</h4>";
