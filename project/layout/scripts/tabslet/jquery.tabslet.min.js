...
jQuery(document).ready(function() {
    $("#slide-wrapper").tabslet({
        ...
        delay: 8, // Sets the delay on automatic rotation - options: number in ms
